...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Destinasi> list;
    ...
    private void showRecyclerList() {
        ...
        ListDestinasiAdapter listPresidentAdapter = new ListDestinasiAdapter(this);
    ...
    private void showRecyclerGrid(){
        ...
        GridDestinasiAdapter gridPresidentAdapter = new GridDestinasiAdapter(this);
    ...
    private void showRecyclerCardView(){
        rvCategory.setLayoutManager(new LinearLayoutManager(this));
        CardViewDestinasiAdapter cardViewPresidentAdapter = new CardViewDestinasiAdapter(this);
